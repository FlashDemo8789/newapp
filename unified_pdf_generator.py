...
# Brand colors for consistent styling using constants.py
BRAND_PRIMARY = colors.HexColor(constants.BRAND_COLORS["primary"])
BRAND_SECONDARY = colors.HexColor(constants.BRAND_COLORS["secondary"])
BRAND_SUCCESS = colors.HexColor(constants.BRAND_COLORS["success"])
BRAND_WARNING = colors.HexColor(constants.BRAND_COLORS["danger"])
BRAND_NEUTRAL = colors.HexColor(constants.BRAND_COLORS["neutral"])
BRAND_ACCENT = colors.HexColor(constants.BRAND_COLORS["accent"])
...
class InvestorReportGenerator(ValidatedPDFGenerator):
    ...
    def __init__(self, doc_data, report_type="full", sections=None):
        ...
        self.colors = {
            'primary': BRAND_PRIMARY,  # Dark blue
            'secondary': BRAND_SECONDARY,  # Light blue
            'accent': BRAND_ACCENT,  # Red
            'success': BRAND_SUCCESS,  # Green
            'warning': BRAND_WARNING,  # Yellow
            'background': BRAND_NEUTRAL,  # Light grey
            'text': BRAND_PRIMARY,  # Dark text
            'light_text': BRAND_NEUTRAL,  # Light text
            'border': BRAND_NEUTRAL  # Border color
        }
